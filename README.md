...
- `Associate Degree in Computer Science` Grossmot and Cuyumaca College _(USA) [site](https://www.gcccd.edu/)._ 2021-2023 (3 years). :paperclip: [here](certificates/Git-Github-Certification.png)
- `CodeAcademy` Online _(USA) [site](https://www.codecademy.com/)._ 2022-2023 (1 year and half). :paperclip: [here](certificates/Terminal-Certification.png)
...
- **Dhari/Farsi:** Native speaker, I am Afghan :afghanistan:
- **English:** Professional working proficiency.:USA:
- **Hindi:** Professional working proficiency.:india:
